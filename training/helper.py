...
root_dir = Path("/cluster/users/tom/git/blink_detection")
...
def get_of_params_options():
    n_layers_options = [3, 5, 7]
    layer_interval_options = [1, 3, 5, 7]
    average_options = [False]
    img_shape_options = [(64, 64)]
    grid_size_options = [4, 7, 10]
    step_size_options = [7]
    window_size_options = [7, 11, 15]
