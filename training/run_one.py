...
def collect_samples_and_predict(
    ...
    if not use_pretrained_classifier:
        ...
        if classifier_params.use_second_classifier:
            xgb_predictions = {}
...
def train_classifier(
    ...
    return classifier, second_classifier, clf_scores
